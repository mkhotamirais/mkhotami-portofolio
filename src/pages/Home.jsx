    ...
    <>
      ...
      <Section id="about">
        ...
        <div className="p-5 rounded-xl mt-3 leading-loose border mx-auto md:w-full xl:w-2/3 shadow-lg">
          <p className="mb-2">
            Graduated from UIN Jakarta in 2022 with a major in Arabic Language and Literature. Developed an interest in web
            programming and subsequently learned JavaScript and ReactJS to enhance front-end development skills. Expanded
            expertise by learning NodeJS and MongoDB for server-side and database management, respectively.
          </p>
          <p className="mb-5">
